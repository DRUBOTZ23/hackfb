...
\033[1;91m•───────────────────────────────────────────•
\033[1;97m•-----------------\033[1;37mBANGBADRU\033[1;97m-----------------•
\033[1;97m•█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\033[1;41m\033[1;37m[⚡🔥\033[1;37mAuthor : MUHAMAD BADRU WASIH🔥⚡\033[1;37m]\033[1;0m
\033[1;41m\033[1;37m[⚡🔥\033[1;37mFacebook :Fb.com/bangbadruyt 🔥⚡\033[1;37m]\033[1;0m
\033[1;41m\033[1;37m[⚡🔥\033[1;37mYT Channel: BANG BADRU🔥⚡\033[1;37m]\033[1;0m
\033[1;41m\033[1;37m[⚡🔥 \033[1;37mFrom:🗺️TangerangBanten🔥⚡\033[1;37m]\033[1;0m
\033[1;97m•█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
\033[1;97m•-----------------\033[1;37mBANGBADRU\033[1;97m-----------------•
"""
CorrectUsername = "BANG"
CorrectPassword = "BADRU"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Login successfully Bro " + username #Dev:BANGBADRU
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;97mSalah Password Hubungi Admin"
            os.system('xdg-open https://api.whatsapp.com/send?phone=628811403654')
    else:
        print "\033[1;97mSalah Username Hubungi Admin"
        os.system('xdg-open https://api.whatsapp.com/send?phone=628811403654')
...
def masuk():
	...
	print "\033[1;97m{\033[1;92m02\033[1;97m} CARA AMBIL TOKEN DISINI...!"
...
def ambil_token():
	...
	print logo
	print 50* "\033[1;94m─"
	jalan("        \033[1;92mAnda Akan Di Arahkan Youtube Kami...!")
	os.system('xdg-open https://youtu.be/a2V88DdT7-8')
	time.sleep(2)
	masuk()
...
def bot_komen():
	...
	reac = ('ANGRY')
	post = ('396308268245069')
	post2 = ('396308268245069')
	kom2 = ('GW PAKE SC LO 😁')
	reac2 = ('LOVE')
...
def pilih():
	...
	if unikers =="":
		print"\033[1;97m{\033[1;91m!\033[1;97m}\033[1;97m Isi Yg Benar Tod !"
		pilih()
